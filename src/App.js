...
function App() {
  return (
    <div className="App">
      ...
      <div className="stream_container">
        <iframe width="640" height="360" src="https://www.youtube.com/embed/bm_-L6felME" title="YouTube video player"
          frameBorder="0"
          allow="autoplay; gyroscope; web-share"
        />
      </div>
      ...
      <div className="stream_container">
        <iframe width="640" height="360" src="https://www.youtube.com/embed/y7QcpQwxHrA" title="YouTube video player"
          frameBorder="0"
          allow="autoplay; gyroscope; web-share"
        />
      </div>
